...
export function Footer() {
  ...
  const fbUrl = getSetting('facebook_url', '#');
  const igUrl = getSetting('instagram_url', '#');
  const twUrl = getSetting('twitter_url', '#');
    ...
    <footer className="bg-primary text-primary-foreground">
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-12 md:py-16">
        ...
        <div className="border-t border-primary-foreground/10 mt-10 pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-primary-foreground/50 text-xs">{t('copyright')}</p>
